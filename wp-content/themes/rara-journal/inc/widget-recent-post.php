...
// register Rara_Journal_Recent_Post widget
function rara_journal_register_recent_post_widget() {
    register_widget( 'Rara_Journal_Recent_Post' );
}
add_action( 'widgets_init', 'rara_journal_register_recent_post_widget' );
 
 /**
 * Adds Rara_Journal_Recent_Post widget.
 */
class Rara_Journal_Recent_Post extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'rara_journal_recent_post', // Base ID
            __( 'RARA: Recent Post', 'rara-journal' ), // Name
            array( 'description' => __( 'A Recent Post Widget', 'rara-journal' ), ) // Args
        );
    }
...
} // class Rara_Journal_Recent_Post 