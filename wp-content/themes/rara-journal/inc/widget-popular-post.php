...
// register Rara_Journal_Popular_Post widget
function rara_journal_register_popular_post_widget() {
    register_widget( 'Rara_Journal_Popular_Post' );
}
add_action( 'widgets_init', 'rara_journal_register_popular_post_widget' );
 
 /**
 * Adds Rara_Journal_Popular_Post widget.
 */
class Rara_Journal_Popular_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'rara_journal_popular_post', // Base ID
			esc_html__( 'RARA: Popular Post', 'rara-journal' ), // Name
			array( 'description' => esc_html__( 'A Popular Post Widget', 'rara-journal' ), ) // Args
		);
	}
 ...
 <div class="post-thumbnail">
                            <a href="<?php the_permalink();?>" class="post-thumbnail">
                                <?php the_post_thumbnail( 'rara-journal-recent-post' );?>
                            </a>
</div>
                        <?php }?>
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'num_post' ) ); ?>"><?php esc_html_e( 'Number of Posts', 'rara-journal' ); ?></label> 
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_postdate' ) ); ?>"><?php esc_html_e( 'Show Post Date', 'rara-journal' ); ?></label>
		</p>
		<?php 
	}
...
} // class Rara_Journal_Popular_Post 